...
# Source: https://codebrowser.dev/qt6/include/linux/input-event-codes.h.html
class KeyCode(IntEnum):
    ...
    KEY_YEN = 124
    KEY_LEFTMETA = 125
    KEY_WIN = KEY_LEFTMETA
    KEY_SUPER = KEY_LEFTMETA
    KEY_META = KEY_LEFTMETA
    KEY_RIGHTMETA = 126
    KEY_RIGHTWIN = KEY_RIGHTMETA
    KEY_RIGHTSUPER = KEY_RIGHTMETA
    KEY_COMPOSE = 127
